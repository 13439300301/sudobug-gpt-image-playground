            ...
            {activeTab === 'api' && (
                ...
                <div>
                  ...
                  <div ref={profileMenuRef} className="relative">
                    <button
                      ...
                      disabled={defaultConfigOnly || activeProfile.provider === 'openai'}
                ...
                <label className="block">
                  ...
                  <div data-selectable-text className="mt-1.5 min-h-[22px] flex items-center text-xs text-gray-500 dark:text-gray-500">
                    {apiProxyEnabled ? (
                      ...
                      <span>已固定为生产 API 地址，客户只需填写 API Key。</span>
                    )}
                  </div>
                </label>
              )}
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200/70 bg-white/60 px-3 py-2.5 text-sm text-gray-700 outline-none transition focus:border-blue-300 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200 dark:focus:border-blue-500/50 disabled:cursor-not-allowed disabled:opacity-50"
                />
                <div data-selectable-text className="mt-1.5 text-xs text-gray-500 dark:text-gray-500">
                  {activeProfile.provider === 'fal' ? (
