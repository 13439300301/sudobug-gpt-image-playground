      ...
      <header data-no-drag-select className={`safe-area-top fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-gray-950/80 backdrop-blur border-b border-gray-200 dark:border-white/[0.08] transition-transform duration-300 ease-in-out ${appMode === 'agent' && !agentMobileHeaderVisible ? '-translate-y-full sm:translate-y-0' : 'translate-y-0'}`}>
        <div className="safe-area-x safe-header-inner max-w-7xl mx-auto flex items-center justify-between relative">
          <div className="flex-1 min-w-0 pr-2 flex items-center gap-2">
            <h1 className="inline-flex min-w-0 items-center relative mr-1">
              {showFavoriteCollectionTitle ? (
                <>
                  ...
                  >
                    <span className="grid h-7 w-7 place-items-center rounded-lg border border-cyan-400/35 bg-cyan-400/10 text-sm font-black text-cyan-300 shadow-[0_0_18px_rgba(34,211,238,0.18)]">
                      S
                    </span>
                    <span>SudoBug</span>
                  </a>
            ...
            <div className="hidden md:flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 items-center rounded-lg border border-cyan-400/35 bg-cyan-400/10 px-3 text-xs font-bold text-cyan-200 shadow-[0_0_16px_rgba(34,211,238,0.12)] transition-colors hover:border-cyan-300/60 hover:bg-cyan-400/15"
              >
                获取API Key
              </a>
              <a
                href="http://www.sudobug.top/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 items-center rounded-lg border border-violet-400/35 bg-violet-400/10 px-3 text-xs font-bold text-violet-200 shadow-[0_0_16px_rgba(167,139,250,0.12)] transition-colors hover:border-violet-300/60 hover:bg-violet-400/15"
              >
                API 中转站
              </a>
            </div>
